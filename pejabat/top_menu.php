...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Penerimaan Obat">
          <a class="nav-link" href="penerimaan/master_in_pejabat.php">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pengeluaran Obat">
          <a class="nav-link" href="pengeluaran/master_out_pejabat.php">
            <i class="fa fa-fw fa-upload"></i>
            <span class="nav-link-text">Permintaan Obat</span>
          </a>
        </li>
  ...
  <div class="content-wrapper" style="background-image: url(../gambar/head1.jpg);">
