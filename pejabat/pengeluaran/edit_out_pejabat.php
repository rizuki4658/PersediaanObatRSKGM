...
<?php
	$link=mysqli_connect('localhost','root','','db_rskgm_obat');
	$a = $_GET['id'];
	$query = "SELECT * FROM out_pejabat WHERE id='$a'";
...
<div class="container" style="margin-left: 20px;">	
	<form method="post" action="cek_edit_out_pejabat.php">
		...
		<table border="0">
			<tr>
				...
				<td style="width: 300px;"><select name="kode_og" id="kode_og" onchange="changeValue(this.value)" class="form-control">
									...
									echo "<option value='0' dselected/>".$data['kode_og']."</option>";
			...
			<tr>
				...
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="jml1" id="jml1" class="form-control" style="width: 120px;" readonly="true" value="<?php echo $data['jumlah1'];?>"></td>
			</tr>
			<tr>
				<td style="width: 200px; height: 50px;"></td>
				<td>&nbsp;&nbsp;</td>
				<td><input type="text" name="satuan_o1" id="satuan_o1" class="form-control" style="width: 120px;" readonly="true" value="<?php echo $data['satuan1'];?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;">Satuan Obat</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="number" name="jml2" id="jml2" class="form-control" style="width: 120px;" value="<?php echo $data['jumlah2'];?>"></td>
			</tr>
			<tr>
				<td style="width: 200px; height: 50px;"></td>
				<td>&nbsp;&nbsp;</td>
				<td>
					<select name="satuan_o2" id="satuan_o2" class="form-control" style="width: 120px;">
						<option value="0"><?php echo $data['satuan2'];?></option>
						<option>Mg</option>	
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="harga" id="harga" class="form-control" style="width: 120px;" value="<?php echo number_format($data['harga']);?>" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;">Nama Pejabat</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="nama_p" id="nama_p" class="form-control" value="<?php echo $data['nama'];?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;">Nama Supplier</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="nama_po" id="nama_po" class="form-control" value="<?php echo $data['nama_penerima'];?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
		...
		<table border="0">
			<tr>
				<td colspan="4" style="width: 300px;">
					<div align="right">
					<a class="btn btn-danger btn-md" href="master_out_pejabat.php">Batal</a>
