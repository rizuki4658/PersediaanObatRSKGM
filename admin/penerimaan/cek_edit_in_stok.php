...
<?php
  ...
  if (mysqli_num_rows($hasil) > 0) {
    while ($data = mysqli_fetch_assoc($hasil)) {
      $i=$data['jumlah_in'];
      $ubah="UPDATE master_stok SET nama_obat='$e',tanggal_in='$b',jumlah_in='$i',satuan='$g',ruangan='$j' WHERE kode_obat='$d'";
      $aksi=mysqli_query($link,$ubah);
    }
  }else{
    $tambah="INSERT INTO master_stok(kode_obat,nama_obat,tanggal_in,jumlah_in,tanggal_out,jumlah_out,harga,satuan,foto,ruangan)VALUES('".$d."','".$e."','".$b."','".$f."','0000-00-00','0','Mg','".$g."','Upload Foto','".$j."')";
    $aksi=mysqli_query($link,$tambah);
  }

  $query="UPDATE in_stok SET tanggal='$b',kode_pg='$c',kode_obat='$d',nama_obat='$e',jumlah='$f',satuan='$g',jumlah_in='$h',satuan_in='$i',ruangan='$j' WHERE kode='$a'";
