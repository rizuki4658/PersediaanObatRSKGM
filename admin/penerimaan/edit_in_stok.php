...
<div class="container" style="margin-left: 20px;">	
	<form method="post" action="cek_edit_in_stok.php">
		<table>
			<tr>
		...
		<table border="0">
			...
			<tr>
				...
				<td style="width: 300px;"><select name="kode_pg" id="kode_pg" onchange="changeValue(this.value)" class="form-control">
									...
									echo "<option value='0' dselected/>".$data['kode_pg']."</option>";
			...
			<tr>
				...
				<td>&nbsp;:&nbsp;</td>
				<td><input type="number" name="jml" id="jml" class="form-control" style="width: 200px;" value="<?php echo $data['jumlah']; ?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				...
				<td>&nbsp;:&nbsp;</td>
				<td>
					<input type="text" name="satuan" id="satuan" class="form-control" style="width: 200px;" value="<?php echo $data['satuan']; ?>" readonly="true"> 
				</td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				...
				<td>&nbsp;:&nbsp;</td>
				<td><input type="number" name="jml_in" id="jml_in" class="form-control" style="width: 200px;" value="<?php echo $data['jumlah_in']; ?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;"></td>
				<td>&nbsp;:&nbsp;</td>
				<td>
					<input type="text" name="satuan_in" id="satuan_in" class="form-control" style="width: 200px;" value="<?php echo $data['satuan_in']; ?>" readonly="true"> 
				</td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				...
				<td>&nbsp;:&nbsp;</td>
				<td>
					<input type="text" name="nama_r" id="nama_r" class="form-control" style="width: 200px;" readonly="true" value="<?php echo $data['ruangan']; ?>">
				</td>
			</tr>
		</table>
		...
		<table border="0">
			<tr>
				<td colspan="4" style="width: 300px;">
					<div align="right">
					<a class="btn btn-danger btn-md" href="master_in_stok.php">Batal</a>
