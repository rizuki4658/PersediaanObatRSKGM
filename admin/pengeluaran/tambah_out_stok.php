...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<a href="master_out_stok.php">Master Pengeluaran Stok</a>
	</li>
...
<div class="container" style="margin-left: 20px;">	
	<form method="post" action="simpan_out_stok.php">
		<table>
			<tr>
	...
	<center>
		<table border="0">
			...
			<tr>
				<td style="width: 200px; height: 50px;">Kode Pejabat</td>
				<td>&nbsp;:&nbsp;</td>
			...
			<tr>
				...
				<td>&nbsp;&nbsp;</td>
				<td><input type="text" name="satuan_o" id="satuan_o" class="form-control" readonly="true"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				...
				<td>&nbsp;&nbsp;</td>
				<td>
					<input type="number" name="jml2" id="jml2" class="form-control" style="width: 200px;" readonly="true">
				</td>
			</tr>
			<tr>
				<td style="width: 200px; height: 50px;">Satuan</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="satuan_o2" id="satuan_o2" class="form-control" readonly="true"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;">Harga</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="harga" id="harga" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
