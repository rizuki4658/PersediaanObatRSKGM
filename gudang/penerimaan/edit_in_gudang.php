...
<?php
	$link=mysqli_connect('localhost','root','','db_rskgm_obat');
	$a = $_GET['kode_p'];
	$query = "SELECT * FROM in_gudang WHERE kode_p='$a'";
...
<div class="container" style="margin-left: 20px;">	
	<form method="post" action="cek_edit_in_gudang.php">
		<table>
			<tr>
				<td>Kode Penerimaan</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="kode_p" id="kode_p" class="form-control" readonly="true" value="<?php echo $data['kode_p']; ?>"></td>
			</tr>
	...
	<center>
		<table border="0">
			<tr>
				...
				<td rowspan="9"><center><img src="../../gambar/warehouse.png" height="300px" width="300px" style="margin-left: 20px;"></center></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;">Kode Obat</td>
				<td>&nbsp;:&nbsp;</td>
				<td style="width: 300px;"><input type="text" name="kode_o" id="kode_o" class="form-control" value="<?php echo $data['kode_obat']; ?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;">Nama Obat</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="nama_o" id="nama_o" class="form-control" value="<?php echo $data['nama_obat']; ?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;">Jumlah Obat</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="number" name="jml_b" id="jml_b" class="form-control" style="width: 80px;" value="<?php echo $data['jumlah1']; ?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				...
				<td>
					<select name="satuan_b" id="satuan_b" class="form-control" style="width: 200px;">
						<option value="0"><?php echo $data['satuan1']; ?></option>
			...
			<tr>
				...
				<td>&nbsp;:&nbsp;</td>
				<td><input type="number" name="jml_o" id="jml_o" class="form-control" style="width: 80px;" value="<?php echo $data['jumlah2']; ?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;"></td>
			...
			<tr>
				...
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="nama_p" id="nama_p" class="form-control" value="<?php echo $data['nama_pet']; ?>"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
		...
		<table border="0">
			<tr>
				<td colspan="4" style="width: 300px;">
					<div align="right">
					<a class="btn btn-danger btn-md" href="master_in_gudang.php">Batal</a>
