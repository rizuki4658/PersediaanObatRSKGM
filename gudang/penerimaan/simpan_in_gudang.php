...
<?php
  ...
  $i=$_POST['nama_p'];
  $j=$_POST['nama_r'];
	$query="INSERT INTO in_gudang(kode_p,tanggal,kode_obat,nama_obat,jumlah1,satuan1,jumlah2,satuan2,nama_pet,ruangan) VALUES('".$a."','".$b."','".$c."','".$d."','".$e."','".$f."','".$g."','".$h."','".$i."','".$j."')";
	...
	?>
        ...
        <br>
        <div align="right"><a href="master_in_gudang.php" class="btn btn-warning btn-md">OK</a></div>
      </div>
    </div>
  	</div>
	</div>
...
?>
	<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="margin-top: 200px;">
        ...
        <br>
        <div align="right"><a href="master_in_gudang.php" class="btn btn-success btn-md">OK</a></div>
      </div>
    </div>
  	</div>
	</div>
