...
<div class="container" style="margin-left: 20px;">	
	<form method="post" action="simpan_out_gudang.php">
		<table>
			<tr>
				<td><i style="color: red;">*</i>Kode Pengeluaran</td>
				<td>&nbsp;:&nbsp;</td>
	...
	<center>
		<table border="0">
			...
			<tr>
				...
				<td>&nbsp;:&nbsp;</td>
				<td><input type="number" name="jml" id="jml" class="form-control" style="width: 120px;"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;">Satuan</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="satuan_o" id="satuan_o" class="form-control" style="width: 120px;" readonly="true"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
				<td style="width: 200px; height: 50px;">Nama Petugas</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input type="text" name="nama_p" id="nama_p" class="form-control" readonly="true"></td>
			</tr>
			<tr><td colspan="3"></td></tr>
			<tr>
...
<script type="text/javascript">
	function validasi() {
		...
		if (kode_i !="" && kode_pen !=0 && tanggal_i !="" && tanggal_i !=0 && kode_ob !="" && nm_o !="" && jum1 !="" && sat1 !="" && jum2 !="" && sat2 !="" && ruangan !="" && nama !="" && ket !=0){
			return true;
		}else{
