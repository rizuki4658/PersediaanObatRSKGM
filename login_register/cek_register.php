...
<?php
  ...
  if(!$link) {
    die('ada error'.mysql_connect_error());
      ...
      $query = "INSERT INTO admin(username,password,nama,email,jabatan) VALUES('".$username."','".$password."','".$nama."','".$email."','".$jabatan."')";
      ...
      <div class="modal-content" style=" background-color: #343a40;">
        ...
        <br>
        <br>
          <center class="text text-light">Daftar Gagal!</center>
        <br>
        <div align="right"><a href="../admin/index.php" class="btn btn-warning btn-md">OK</a></div>
      </div>
    </div>
    </div>
  </div>
...
?>
      ...
      <div class="modal-content" style=" background-color: #343a40;">
        ...
        <br>
        <br>
          <center class="text text-light">Daftar Berhasil!</center>
        <br>
        <div align="right"><a href="../admin/index.php" class="btn btn-success btn-md">OK</a></div>
      </div>
    </div>
    </div>
  </div>
